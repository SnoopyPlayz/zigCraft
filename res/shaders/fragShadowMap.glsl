...
void main()
{
    ...
    float bias = max(0.000002 * (1.0 - dot(normal, l)), 0.0000002) - 0.00001;
    //float bias = max(0.02 * (1.0 - dot(normal, l)), 0.002);
    int shadowCounter = 0;
    ...
    // change how dark shadow
    finalColor += texelColor * (0.1) * colDiffuse;
